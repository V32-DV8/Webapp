...
export const tasks: Task[] = [
  ...
  { id: 't22', title: 'Update resume with recent projects', description: 'Add v32 task and analytics dashboard', completed: false, priority: 3, projectId: 'p2', sectionId: 's4', labels: ['Personal', 'Career'], dueDate: nextWeek, createdAt: subDays(new Date(), 5).toISOString(), subtasks: [], order: 3, status: 'todo' },
